...
// Type: Julios.CasterCheckStoredValueCondition2
...
namespace Julios
{
  public class CasterCheckStoredValueCondition2 : EffectConditionSO
  {
    ...
    {
      return caster.GetStoredValue(this._valueName) < 4;
    }
  }
}
